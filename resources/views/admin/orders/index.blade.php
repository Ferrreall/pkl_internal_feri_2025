    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3">
            ...
            <ul class="nav nav-pills card-header-pills">
                ...
                <li class="nav-item">
                    {{-- Di database kamu isinya 'shipped', jadi filternya pakai 'shipped' --}}
                    <a class="nav-link {{ request('status') == 'shipped' ? 'active' : '' }}"
                        href="{{ route('admin.orders.index', ['status' => 'shipped']) }}">Diproses</a>
                </li>
                <li class="nav-item">
                    {{-- Di database kamu isinya 'delivered', jadi filternya pakai 'delivered' --}}
                    <a class="nav-link {{ request('status') == 'delivered' ? 'active' : '' }}"
                        href="{{ route('admin.orders.index', ['status' => 'delivered']) }}">Selesai</a>
                </li>
            </ul>
        </div>
